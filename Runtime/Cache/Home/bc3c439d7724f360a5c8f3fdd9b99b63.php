...
<head>
    ...
    <title>用户登录</title>
    <link href="<?php echo (BASE_CSS); ?>User_Login.css" type="text/css" rel="stylesheet" />
        ...
        <form action="#" method="post">
            <ul>
                    ...
                    <div class="user_main_box">
                        ...
                        <ul>
                            ...
                            <li class="user_main_input">
                                ...
                                <img src="<?php echo (BASE_IMG); ?>admin.png"  alt="" />
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="user_main_r">
                    ...
                    <input style="border: medium none; background: url('<?php echo (BASE_IMG); ?>user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                </li>
            </ul>
        </form>
